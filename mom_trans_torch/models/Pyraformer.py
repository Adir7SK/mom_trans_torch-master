...
#     PositionalEncoding,
# )
# from LTSF_Linear.models.model.Pyraformer import Pyraformer
#
#
# class PyraformerBaseline(DeepMomentumNetwork):
...
#         self.masking = True
#         self.pyraformer = Pyraformer(c_in=hidden_dim, seq_len=0, d_model=hidden_dim, n_heads=4,
#                                     e_layers=2, factor=5, dropout=dropout)
...
#         x = self.grn(x)
#         out = self.pyraformer(x, attn_mask=attn_mask)
