...
#     PositionalEncoding,
# )
# from LTSF_Linear.models.model.LightTS import LightTS
#
#
# class LightTSBaseline(DeepMomentumNetwork):
...
#         self.masking = True
#         self.lightts = LightTS(c_in=hidden_dim, d_model=hidden_dim, n_layers=2,
...
#         x = self.grn(x)
#         out = self.lightts(x, attn_mask=attn_mask)
